...
import SettingsPopover from '../../../components/pomodoro/SettingsPopover';
...
const PomodoroTimer = () => {
    ...
    useEffect(() => {
        ...
        const storedSettings = JSON.parse(
            window.localStorage.getItem('pomodoroSettings'),
        );
        ...
        if (storedSettings) {
            ...
            setTimeLeft(
                (storedSettings.pomodoroTime || defaultPomodoroTime) * 60,
            );
        } else {
