    ...
    return (
        <div className="absolute inset-0 flex flex-col items-center justify-center z-50">
            ...
            <div className="flex items-center">
                <IconButton variant="text" className={`rounded-full w-24 h-24 mr-[32px] transition-opacity duration-200 ${isActive ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <IconButton variant="text" className={`rounded-full w-24 h-24 ml-[32px] transition-opacity duration-200 ${isActive ? 'opacity-0' : 'opacity-100'}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-white">
