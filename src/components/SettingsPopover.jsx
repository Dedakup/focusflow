...
const SettingsPopover = ({ isVisible, isActive, handlePomodoroChange, handleShortBreakChange, handleLongBreakChange, pomodoroTime, shortBreakTime, longBreakTime }) => {
        ...
        <Popover placement="left" offset={{ mainAxis: 10 }}>
            ...
            <PopoverContent className="w-80 h-auto p-4 bg-gray-700 text-white z-50">
                <div className="flex flex-col space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-white">Pomodoro</label>
                        <input
                            type="number"
                            value={pomodoroTime}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-white">Short break</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-white">Long break</label>
                        <input
                            type="number"
                            value={longBreakTime}
