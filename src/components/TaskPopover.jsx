              ...
              tasks.map((task) => (
                <div
                  ...
                  className={`flex items-center justify-between bg-gray-800 p-2 rounded ${
                    task.selected ? 'bg-green-600' : 'bg-gray-700'
                  }`}
                >
                    ...
                    <button onClick={() => handleEditTask(task.id)}>
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M15.232 5.232l3.536 3.536m-3.536-3.536L7.768 13.464a2.25 2.25 0 00-.618 1.414V18h3.121a2.25 2.25 0 001.414-.618l6.464-6.464a2.25 2.25 0 00-3.182-3.182z"
                        />
                      </svg>
                    </button>
                    <button onClick={() => deleteTask(task.id)}>
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M19.5 6h-15m3 0v12a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 18V6m-12 0V4.5A1.5 1.5 0 017.5 3h9A1.5 1.5 0 0118 4.5V6m-6 4.5v6m-3-6v6m6-6v6"
                        />
                      </svg>
                    </button>
                  </div>
